...
def main():
    ...
    date_key = analysis.report_date[:7]
    ...
    print(f"Listings analyzed: {analysis.total_listings}")
    print(f"Anomalies found: {len(anomaly_report.anomalies)}")
    print(f"Recommendations: {len(rec_report.recommendations)}")
    print(f"\nExecutive Summary would be generated by LLM in full run.")
    print(f"History saved to: data/history/{args.client}/")
